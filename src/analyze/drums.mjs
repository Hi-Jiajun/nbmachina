...
export const DEFAULT_DRUM_CONFIG = {
  ...
  frameSize: 1024,           // 23.2ms @44.1kHz：够分辨 40–120Hz 与 150–400Hz 两段，也够抓瞬态
  hopSec: 0.005,             // 5ms 帧长
  promWindowSec: 0.1,        // 突出度 = 峰 / ±100ms 局部均值
  latencyFactor: 0.5,        // 加窗通量峰比真实起音提前 ≈ 0.5×窗长（M1-3 实测口径）
  ...
  // 合成的真打击：底鼓 0.73 / 军鼓 0.73 / 踩镲 0.85；噪声尾巴上的假峰 ≤0.18 → 取 0.35。
  minExcess: 0.35,
